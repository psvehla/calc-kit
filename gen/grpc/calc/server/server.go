...
// "multiply" endpoint.
func NewMultiplyHandler(endpoint endpoint.Endpoint, h goagrpc.UnaryHandler) goagrpc.UnaryHandler {
	if h == nil {
		h = goagrpc.NewUnaryHandler(goa.Endpoint(endpoint), DecodeMultiplyRequest, EncodeMultiplyResponse)
	}
	return h
}
